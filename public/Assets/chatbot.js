...
document.getElementById("modalComplaintSubmitButton").addEventListener("click", () => {
  customerName = document.getElementById("complaintModalName").value
  customerEmail = document.getElementById("complaintModalEmail").value
  customerPhoneNumber = document.getElementById("complaintModalPhoneNumber").value
  customerComplaint = document.getElementById("complaintModalComplaint").value

  if(customerName == ""){
    showComplaintError("Please enter your name")
  } else if (customerEmail == ""){
    showComplaintError("Please enter your email address")
  } else if (customerComplaint == ""){
    showComplaintError ("Please enter your complaint")
  } else {
    document.getElementById("complaintModalName").style.display = "none"
    document.getElementById("complaintModalEmail").style.display = "none"
    document.getElementById("complaintModalPhoneNumber").style.display = "none"
    document.getElementById("complaintModalComplaint").style.display = "none"
    document.getElementById("modalComplaintSubmitButton").style.display = "none"

    document.getElementById("complaintSuccess").innerHTML = "Successfully submitted your complaint. We will get back to you shortly."
    document.getElementById("complaintSuccess").style.display = "block"
    document.getElementById("closeComplaintModal").style.display = "block"
  }

  console.log(customerName,customerEmail,customerPhoneNumber,customerComplaint);
})

function showComplaintError (message){
  document.getElementById("complaintFailure").innerHTML = message
  document.getElementById("complaintFailure").style.display = "block"

  setTimeout(() => {
    document.getElementById("complaintFailure").style.display = "none"
  },2500)
}


$("#my-id").on("hidden", function() {
  document.getElementById("complaintSuccess").style.display = "none"
  document.getElementById("closeComplaintModal").style.display = "none"

  document.getElementById("complaintModalName").style.display = "block"
  document.getElementById("complaintModalEmail").style.display = "block"
  document.getElementById("complaintModalPhoneNumber").style.display = "block"
  document.getElementById("complaintModalComplaint").style.display = "block"
  document.getElementById("modalComplaintSubmitButton").style.display = "block"

  document.getElementById("complaintModalPhoneNumber").value = ""
  document.getElementById("complaintModalComplaint").value = ""
})
