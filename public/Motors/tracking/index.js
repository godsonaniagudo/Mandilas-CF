...
//   Username: "apikey",
//   Password: "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",
//   To: 'tiergodson@gmail.com',
//   From: "tiergodson@gmail.com",
//   Subject: "MAndilas Test",
//   Body: "Welcome!"
// }).then(() => {
//   console.log("Done");
// })
  ...
  if(trackingID != null && trackingID != ""){
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        const myNode = document.getElementById("detailsList1");
        while (myNode.firstChild) {
          myNode.removeChild(myNode.firstChild);
        }

        const myNode2 = document.getElementById("detailsList2");
